    ...
    <div class="Register">
        ...
        <div class="RegisterContent">
            <div class="content">
                <div class="row1 row">
                    <div class="left">
                        <x-input class="input" placeholder="手机号码" v-model="tel"></x-input>
                    </div>
                    <div class="right">通过手机号找回</div>
                </div>
                <div class="row2 row">
                    <div class="left">
                    ...
                    <div class="right"  @click="go('/ForgetEmail')">Or 通过邮箱找回</div>
                </div>
                <div class="row2 row">
                    <div class="left">
                ...
                <div class="row3 row">
                    <div class="left"><x-button class="btn" @click.native="findpsd">找回密码</x-button></div>
                    <div class="right">&nbsp;</div>
                </div>
